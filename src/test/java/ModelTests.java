...
public class ModelTests {
    ...
    public void checkNotTie(){
        Model model = new Model(new byte[]{0,0,0,1,0,2,0,0,0});
        assertFalse(model.checkTie());
    }

    @Test
    public void checkTie(){
        Model model = new Model(new byte[]{1,1,2,2,1,1,1,2,2});
    ...
    public void checkWin(){
        Model model = new Model(new byte[]{2,1,2,2,1,0,0,1,1});
        assertTrue(model.checkWin());
    }

    @Test
    public void cannotPlaceMark(){
        Model model = new Model(new byte[]{1,0,0,0,0,0,0,0,0});
